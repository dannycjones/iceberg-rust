...
# licenses those dependencies use. DEPENDENCIES.rust.tsv only records SPDX
# identifiers, so packages that ship binaries (currently bindings/python) also
# carry an about.toml plus about.hbs and get full license texts.
#
